...
const StartChapter = () => {
  return (
    <div className="h-full-max bg-med-tan">
      <div className="px-20">
        <div className="py-3">
        ...
        <div className="gap-y-3 text-xl">
          <p className="py-3">
            ...
            starting a chapter of The Legacy Project, Inc. (TLP) at their
            US-based college or university.{" "}
          </p>
          <p className="py-3">
            ...
            documenting and amplifying the life stories of the older generation
            to ensure that their legacies are preserved for years to come.
          </p>
          <p className="py-3">
            We encourage all to apply,{" "}
            <strong> no experience necessary, </strong> and we will be in
            contact soon to explore this opportunity.{" "}
          </p>
          <p className="py-3">
            {" "}
