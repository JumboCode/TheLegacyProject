...
export function StudentTile({
  ...
  return (
    <div className="p-4 relative flex h-64 w-64 flex-col items-center justify-center gap-4 rounded bg-white text-base font-medium text-gray-700 drop-shadow-md">
