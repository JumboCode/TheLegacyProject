...
const Sidebar = ({ displayName } : { displayName: string }) => {
  return (
    ...
    <div className="flex w-full sticky top-0 flex h-screen flex-col items-center justify-between bg-nav-taupe px-6 py-8 shadow-xl drop-shadow-xl">
      <div className="w-full items-center p-2">
        ...
        <Link href="/home">
          <button className="w-full rounded bg-nav-teal px-5 py-3 text-center font-serif text-xl text-white \
