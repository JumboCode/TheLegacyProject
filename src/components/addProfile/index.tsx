...
const AddProfile = <T extends { selectName: string[] }>({
  ...
  return (
    <>
      <div className="absolute inset-y-0 right-0 h-screen w-[84%] bg-[#F5F5F5] font-sans">
        <ProfileHeader title={"Add New Member"} icon={undefined} />
        <AddProfileForm
