...
const ResourceTile = ({
  ...
  return isEdit ? (
    <div className="flex h-56 w-full flex-col justify-between rounded-lg bg-white px-8 py-4 shadow-lg shadow-gray-500">
      <div>
        <input
          {...register("title", {
            onChange: (e) => {
    ...
    <div className="flex h-24 w-full flex-col gap-y-2.5 rounded-lg bg-white p-6 shadow-lg shadow-gray-500">
